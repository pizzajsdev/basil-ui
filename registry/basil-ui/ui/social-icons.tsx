...
export function BuyMeACoffeeIcon(props: React.ComponentProps<'svg'>) {
  return (
    ...
    >
      ...
      <path d="m20.2 6.4-.1-.7c-.1-.5-.4-1.1-1-1.3l-.6-.3-.2-.5-.2-1.2c0-.3-.1-.7-.3-1-.2-.4-.6-.6-1-.8a5.7 5.7 0 0 0-.6-.1c-1-.3-2-.4-3-.5a25.8 25.8 0 0 0-3.8.1c-.9 0-1.8.2-2.7.5l-.9.5a1 1 0 0 0-.2 1.1c.2.3.4.5.7.6l1.1.4 3.3.4a25 25 0 0 0 4.6-.3c.3 0 .6-.5.4-.8 0-.4-.4-.5-.8-.5l-1.4.2H10A22.2 22.2 0 0 1 8.8 2h-.2l-.7-.2c-.2 0-.2-.2 0-.2l.8-.2h.4a25 25 0 0 1 3.4-.1l2 .1h.3l.8.2c.4 0 .9.1 1 .5l.1.5.4 1.4a.2.2 0 0 1-.2.3h-.1a36.7 36.7 0 0 1-4.8.3 37 37 0 0 1-4.7-.3H7l-1-.2c-.4 0-.7 0-1.1.2-.3.1-.5.4-.7.7L4 6l-.2 1c.1.8.6 1.4 1.4 1.5a39.7 39.7 0 0 0 11.3.4.5.5 0 0 1 .6.5l-.1.7-1 10-.1 1.2c-.2.6-.6 1-1.2 1.2l-1.8.2h-2c-.7 0-1.5-.1-2-.6S8.2 21 8 20.4l-.7-7-.3-3.1c0-.4-.3-.7-.7-.7-.3 0-.7.3-.7.7l.3 2.1 1 9.2c0 1.3 1 2 2.4 2.2l2.2.2 3-.1c1.3-.3 2.4-1.2 2.5-2.7l1-10 .3-2a.5.5 0 0 1 .4-.5c.4 0 .7-.2 1-.5.5-.5.6-1.1.4-1.8zm-1.5.8a40.7 40.7 0 0 1-13.6 0v-1c0-.3.2-.6.5-.6.5-.1 1 .1 1.5.2a29 29 0 0 0 9.2 0c.5 0 1 0 1.4-.2.4 0 .8-.2 1 .2.2.3.2.7.2 1a.5.5 0 0 1-.2.4zM12.6 11c-.9.4-1.9.8-3.1.8a5.9 5.9 0 0 1-1.6-.2l.9 9c0 .7.7 1.3 1.5 1.3a54.5 54.5 0 0 0 3.4 0c.8 0 1.5-.6 1.5-1.3l1-10a4 4 0 0 0-1.4-.2c-.8 0-1.5.3-2.2.6z" />
    </svg>
  )
}
...
export function ThreadsIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg
      role="img"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <title>Threads</title>
      <path d="M12.19 24h-.01C8.6 23.98 5.85 22.8 4 20.5c-1.65-2.07-2.5-4.92-2.53-8.5v-.02C1.5 8.41 2.35 5.56 4 3.51 5.84 1.21 8.6.02 12.18 0h.01c2.75.02 5.05.72 6.83 2.1a10.1 10.1 0 0 1 3.5 5.46l-2.03.57c-1.1-3.96-3.9-5.98-8.3-6.01-2.91.02-5.11.94-6.54 2.72C4.3 6.5 3.62 8.9 3.59 12c.03 3.09.72 5.5 2.06 7.16 1.43 1.79 3.63 2.7 6.54 2.72 2.62-.02 4.35-.63 5.8-2.04a4.3 4.3 0 0 0 1.09-4.8 3.86 3.86 0 0 0-1.64-1.75 6.63 6.63 0 0 1-1.28 3.27 4.9 4.9 0 0 1-3.73 1.79 5.48 5.48 0 0 1-3.26-.8 3.74 3.74 0 0 1-.42-6.05 5.93 5.93 0 0 1 3.58-1.29 13.85 13.85 0 0 1 3.02.14 3.49 3.49 0 0 0-.75-1.75c-.51-.59-1.3-.89-2.36-.9h-.03c-.84 0-1.99.24-2.72 1.33L7.73 7.85a5.2 5.2 0 0 1 4.48-2.26h.05c3.19.02 5.1 1.98 5.28 5.39l.32.14a6.2 6.2 0 0 1 3.16 3.07 6.4 6.4 0 0 1-1.55 7.16c-1.85 1.8-4.1 2.63-7.28 2.65Zm1-11.69c-.24 0-.49 0-.74.02-1.84.1-2.98.95-2.92 2.14.07 1.26 1.46 1.84 2.79 1.77 1.22-.06 2.82-.54 3.08-3.7a10.5 10.5 0 0 0-2.21-.23z" />
    </svg>
  )
}
